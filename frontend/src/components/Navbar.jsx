...
const NavBar = ()=>{
    ...
    return(
    <>
    <header  class=" z-40 flex items-center justify-between w-screen px-4  text-lg bg-white border-b-2 shadow-md h-header border-bsprime">
  <div class="w-1/6">
  ...
  <nav class="flex flex-row items-center justify-center w-4/6 gap-10">
    ...
    <div class="dropdown">
        <span class="font-extrabold text-black transition-colors ease-in-out hover:text-accent active:text-blue-400" style={{cursor:'pointer'}}>24/7 help</span>
